...
"""
def getImageBatch(full_video_path, frames_to_process, select_every_nth_frame, starting_frame):
...
class FrameSelector:
    ...
    def process_video(
        ...
        (current_image, _) = getImageBatch(full_video_path, 1, 1, current_frame - 1)
        (in_out_images, target_frame_time) = getImageBatch(full_video_path, frames_to_process, select_every_nth_frame, starting_frame)
